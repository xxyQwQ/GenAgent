...
from agent.gen_agent.utils.function import fetch_reference_by_name
from agent.gen_agent.agent.analyzer import get_analyzer_agent_prompt
from agent.gen_agent.agent.planner import (
    get_planner_agent_prompt,
    parse_planner_agent_response,
    parse_planner_agent_action
)
from agent.gen_agent.agent.combiner import (
    get_combiner_agent_prompt,
    parse_combiner_agent_response
)
from agent.gen_agent.agent.adapter import (
    get_adapter_agent_prompt,
    parse_adapter_agent_response
)
from agent.gen_agent.agent.refiner import (
    get_refiner_agent_prompt,
    parse_refiner_agent_response
)


class GenAgentPipeline:
    def __init__(
        self,
        save_path: str,
        num_steps: int = 5,
